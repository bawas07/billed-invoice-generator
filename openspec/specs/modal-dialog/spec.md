...
Provide a reusable modal dialog component with backdrop overlay, keyboard dismissal, transitions, and slot-based content areas.
...
- **AND** the dialog SHALL scale in from 0.92 over 200ms
